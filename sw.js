...
// BELANGRIJK: verhoog CACHE_VERSION elke keer dat je een nieuwe index.html
// (of manifest.json/pwa-icon.svg) naar Vercel upload — anders blijven
// gebruikers een oude, gecachete versie van het dashboard zien.
